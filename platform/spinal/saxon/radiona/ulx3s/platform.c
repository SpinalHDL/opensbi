...
static int vex_system_reboot(u32 type)
{
	writel(1, (void*)SYSTEM_SYSTEM_CTRL_CTRL);
	while(1){};
	return 0;
}

static int vex_system_shutdown(u32 type)
{
	writel(2, (void*)SYSTEM_SYSTEM_CTRL_CTRL);
	while(1){};
	return 0;
}
...
const struct sbi_platform_operations platform_ops = {
	...
	.system_reboot		= vex_system_reboot,
	.system_shutdown	= vex_system_shutdown
};
